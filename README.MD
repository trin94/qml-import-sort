...
The tool can run as a [pre-commit](https://pre-commit.com) or [prek](https://prek.j178.dev) hook.
...
Go does not need to be installed. Both frameworks download the Go toolchain on demand
