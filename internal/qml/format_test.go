...
func TestFormatClassification(t *testing.T) {
	runFormatCases(t, []formatCase{
		...
		{
			name:       "QML base module import is grouped with qt imports",
			lineEnding: "\n",
			input: []string{
				"import QtQuick",
				"import MyModule",
		...
		{
			name:       "dotted QML subpath is grouped with qt imports",
			lineEnding: "\n",
			input: []string{
				"import QML.Foo",
				"import MyModule",
...
func TestFormatComments(t *testing.T) {
	runFormatCases(t, []formatCase{
		...
		},
		{
			...
			input: []string{
				"import ZZZ",
				"// first hoisted comment",
				"// second hoisted comment",
				"// third hoisted comment",
				"import AAA",
				"",
				"Rectangle {",
				"}",
	...
	runFormatCases(t, []formatCase{
		...
		},
		{
			...
			input: []string{
				...
				"import io.github.mpvqc.Alpha",
				"import io.github.mpvqc.Beta",
				"import io.github.mpvqc.Alpha",
				"import io.github.other",
				"",
				"Rectangle {",
